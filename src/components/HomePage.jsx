...
const HomePage = () => {
  const games = [
    ...
    },
    {
      ...
      description: 'The legendary fighting game series returns with new mechanics',
    },
    {
      title: 'Mortal Kombat 1',
      image:
        'https://cdn.cloudflare.steamstatic.com/steam/apps/1971870/header.jpg',
      description: 'Enter the brutal world of Mortal Kombat with a fresh start',
    },
    {
      title: 'NBA 2K24',
      image:
        'https://cdn.cloudflare.steamstatic.com/steam/apps/2338770/header.jpg',
      description: 'The most authentic basketball simulation experience',
    },
    {
      title: 'Tekken 8',
      image:
        'https://cdn.cloudflare.steamstatic.com/steam/apps/1778820/header.jpg',
      description: 'The next evolution of the legendary fighting franchise',
    },
    {
      title: 'Rocket League',
      image:
        'https://cdn.cloudflare.steamstatic.com/steam/apps/252950/header.jpg',
      description: 'Soccer meets driving in this award-winning competitive game',
    }
  ];
